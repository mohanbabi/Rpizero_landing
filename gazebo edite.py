...
def msg_receiver(frame):
    global notfound_count, found_count, time_last, time_to_wait, aruco_id_to_find
        ...
        try:
            if ids is not None:
                if aruco_id_to_find in ids:
                    ...
                    print(f'FOUND COUNT: {found_count} - NOTFOUND COUNT: {notfound_count}')
